...
final class MuteCommand extends BaseCommand {
    ...
    public function __construct(private readonly Loader $plugin) {
        parent::__construct($plugin, "mute", "Mute players");
        $this->setPermission("sentinel.command.mute");
    }
    ...
    public function onRun(CommandSender $sender, string $aliasUsed, array $args): void {
        ...
        if (!$sender->hasPermission("sentinel.command.mute")) {
        ...
        $sender->sendForm(new SanctionForm($this->plugin, $targetPlayer, true));
    }
}
